...
class element:
    def __init__(self, i):
        self.__poz = tk.Frame(scrolable)
        self.__poz.pack()
        self.__id = tk.Entry(self.__poz,  borderwidth = 1,justify = "center")
        self.__id.pack(side = tk.LEFT)
        a = tk.Entry(self.__poz,  borderwidth=1, justify = "center")
        a.pack(side = tk.LEFT)
        b=tk.Entry(self.__poz,  borderwidth=1,justify = "center")
        b.pack(side = tk.LEFT)
        c = tk.Entry(self.__poz,  borderwidth=1,justify = "center")
        c.pack(side = tk.LEFT)
        d = tk.Entry(self.__poz, borderwidth=1,justify = "center")
        d.pack(side = tk.LEFT)
        self.__id.insert(0,str(i[0]))
        self.__id.configure(state = tk.DISABLED)
        a.insert(0, str(i[1]))
        ...
        tk.Button(self.__poz, text = "DEL", command = self.delete).pack(side = tk.LEFT)

    def delete(self):
        delete(int(self.__id.get()))
        self.__poz.destroy()
